...
class first : AppCompatActivity(),View.OnClickListener{
    ...
    private fun check(){
        ...
        if(winnerPlayer==1){
            ...
            if (scoreFirst==winningNum){
                val intent1 = Intent(this, LastActivity::class.java).also {
                    it.putExtra("winnerPlayer", textView2.text.toString())
                    it.putExtra("firstPlayer", textView2.text.toString())
                    it.putExtra("secondPlayer", textView3.text.toString())
                    it.putExtra("winningScore",winningNum)
                    it.putExtra("winnerNum",num)
                }
        ...
        if(winnerPlayer==2){
            ...
            if (scoreSecond==winningNum){
                val intent1 = Intent(this, LastActivity::class.java).also {
                    it.putExtra("winnerPlayer", textView3.text.toString())
                    it.putExtra("firstPlayer", textView2.text.toString())
                    it.putExtra("secondPlayer", textView3.text.toString())
                    it.putExtra("winningScore",winningNum)
                    it.putExtra("winnerNum",num)
